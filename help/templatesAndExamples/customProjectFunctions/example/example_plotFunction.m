...
%
function example_plotFunction( results, options )
    ...
    parser.add('variablesToPlot',{'growthCurve_exponential', 'growthCurve_prime'});
    parser.add('blackList',{'plotFunction','character'});
    ...
    f = namedFigure('(Example) Population Dynamics');
    clf;
    hold on;
    ...
    legend;
    xlabel('Epoch (years)');
    ylabel('Herd Size (millions)');
    title(sprintf('Population Dynamics of the %s in Northwest Tatooine',results.character));
