function interfacePanel = RS_SMA100B_clockSource_createInterface(interfacePanel)
    ...
    if(interfacePanel.UserData.interfaceIndex <= 0) 
        ...
        interface.clock_type = 'Single Sine'; % options: Single Sine, Differential Sine, Differential Square
        % -----------------------------------------
        
        % DO NOT EDIT THIS: -----------------------
        interface.type = 'RS SMA100B Clock Source';
